...
public class VenueSearchGuideFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        Glide.with(this).asGif().load(R.raw.venue_searh_function).into(gif_guide);
        description.setText("Search venue by filter");
